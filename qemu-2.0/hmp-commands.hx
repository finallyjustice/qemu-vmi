...
ETEXI
	
	{
        ...
        .args_type  = "action:s",
        .params     = "action",
        .help       = "log the memory access in VM",
        .mhandler.cmd = hmp_mem_logger,
    },

STEXI
@item mem-logger @var{action}
@findex mem-logger
start or stop the memory access logger in VM
ETEXI

	{
        ...
        .params     = "action",
        .help       = "listen comm",
        .mhandler.cmd = hmp_listen,
    },

STEXI
@item listen @var{action}
@findex listen
...
ETEXI

	{
        ...
        .args_type  = "",
        .params     = "",
        .help       = "obtain the network device info",
        .mhandler.cmd = hmp_ifconfig,
    },

STEXI
@item ifconfig
@findex ifconfig
obtain the network device info
ETEXI

	{
        ...
        .args_type  = "",
        .params     = "",
        .help       = "obtain the hostname information",
        .mhandler.cmd = hmp_hostname,
    },

STEXI
@item hostname
@findex hostname
obtain the hostname information
ETEXI

	{
        .name       = "read",
        .args_type  = "class:s,type:s,size:l,addr:l",
        .params     = "class type size addr",
        .help       = "read data at addr",
        .mhandler.cmd = hmp_read_data,
    },

STEXI
@item read @var{class} @var{type} @var{size} @var{addr}
@findex read
...
ETEXI
	...
	{
        .name       = "translate",
        .args_type  = "gva:l,cr3:l",
        .params     = "gva cr3",
        .help       = "translate gva to gpa according to cr3",
        .mhandler.cmd = hmp_trans_addr,
    },

STEXI
@item translate @var{gva} @var{cr3}
@findex translate
translate gva to gpa according to cr3
ETEXI
	
	{
        ...
        .args_type  = "",
        .params     = "",
        .help       = "obtain the memory usage of VM",
        .mhandler.cmd = hmp_free,
    },

STEXI
@item free
@findex free
obtain the memory usage of VM
ETEXI

	{
        ...
        .args_type  = "",
        .params     = "",
        .help       = "obtain the cpu usage of VM",
        .mhandler.cmd = hmp_top,
    },

STEXI
@item top
@findex top
obtain the cpu usage of VM
ETEXI

	{
        ...
        .args_type  = "action:s",
        .params     = "action",
        .help       = "system call table integrity checker",
        .mhandler.cmd = hmp_syscall_checker,
    },

STEXI
@item check_syscall @var{action}
@findex checksyscall
System call table integrity checker
ETEXI

	{
        ...
        .args_type  = "",
        .params     = "",
        .help       = "external ps command",
        .mhandler.cmd = hmp_list_process,
    },

STEXI
@item ps
@findex ps
This is a command to show a list of processes in guest OS
ETEXI

	{
        ...
        .args_type  = "",
        .params     = "",
        .help       = "external lsmod command",
        .mhandler.cmd = hmp_list_modules,
    },

STEXI
@item lsmod
@findex lsmod
This is a command to show a list of modules in guest OS
ETEXI
